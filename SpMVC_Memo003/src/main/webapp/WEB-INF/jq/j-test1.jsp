...
// 이곳에서 body tag에 바탕색을 red로 설정하는 js코드를 작성한다면
// js 코드는 문법 오류를 낼 것이다.
// 그리고 이후의 js코드는 모두 무시해 버린다.
// 그래서 표준 js코드에서는 tag에 어떤 속성을 변경하는 코드는
// 문서끝의 body, html이 끝난 이후에 작성을 한다.

//document.getElemntById("body").setAttribute("backgroundColor,"red")

// 이러한 불편때문에 JQuery는 document.ready라는 키워드를 만들었다.
// document.ready(function(){}) 문법은
// 현재 문서의 html이 모두 완성된 다음에 
// function으로 지정된 영역의 코드를 실행하라 라는 것
