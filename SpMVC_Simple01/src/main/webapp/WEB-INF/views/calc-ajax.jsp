...
$(function(){
	$("#btn-send").click(function(){
		...
		// Ajax를 사용해서 controller에게 두 값을 보낸다.
		$.ajax({
			url : "${pageContext.request.contextPath}/add-ajax",
			method : "POST",
			date : {intNum1:num1, intNum2:num2},
...
<body>
	<form action="calc-vo" method = "POST">
		<p>숫자1 : <input type = "text" id="intNum1" name ="intNum1" value="${CALC.intNum1}">
		<p>숫자2 : <input type = "text" id="intNum2" name ="intNum2" value="${CALC.intNum2}">
