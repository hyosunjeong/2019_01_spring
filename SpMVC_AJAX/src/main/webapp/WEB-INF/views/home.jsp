...
<script>
	$(function() {
		...
		$(".p-tr").click(
				function() {
					// id값을 추출할 수 있으면 몇번째 tr이 클릭 되었는지 알 수 있다
					...
					// $(...).text() 어떤 tag 내부에 있는 text를 
					// getter하거나 setter하는 함수
			...
			// forEach와 원리가 비슷한데
			// .isum 클래스 개수만큼 자동반복하면서
			// item에 각각 한개의 항목(select)들을 저장해 준다.
...
<body>
	...
	<nav>
		<a href="#">홈</a> <a href="#">상품검색</a> <a href="#">About</a>
