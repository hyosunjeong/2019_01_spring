...
public class MybatisConfig {
	...
	/*
	 * SqlSessionFactory = 오라클과 연결할 떄 사용할 Bean
	 */
	@Bean
	...
	/*
	 * Transaction Manager
	 * transactionManager : 이 method는 
	 * Spring에 의해 직접 호출되는 사항이어서 이름을 변경하면 안된다
	 * 
	 * tx : 최신버전 spring에서는 method 이름을 tx로 사용해도 된다
	 * 
	 * @EnableTransactionManager Annotation이 활성화(사용가능)되려면
	 * 이 method가 선언되어 있어야 한다.
	 */
	@Bean
