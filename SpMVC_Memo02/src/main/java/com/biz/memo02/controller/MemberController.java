...
public class MemberController {
	...
	/*
	 * @ModelAttribute Annotation은 form으로부터 전송되어온
	...
	public String member(Model model, @ModelAttribute MemberVO memberVO) {
	 ...
	 * Dao의 userCheck를 사용해서 id와 p[assword를 조회하고
	 * 결과를 return 받아서 vo에 답았다.
	 * 
	 * 만약 id와 password가 일치하면 
	 * vo는 member 데이터를 갖고 있을 것이고
	 * 그렇지 않으면 null 값을 가지게 된다.
	 * 
	 * 즉, vo가 null 이면 login 실패
	 * 아니면 로그인 성공이 된다.
	 * 
	 */
		String ret = "";
