...
public class MemberController {
	...
	public String join(@ModelAttribute MemberVO memberVO) {
		...
		// 생성자의 4부터 31까지의 임의의 정수를 포함할 수 있다
		// 생략할 경우 10이 적용된다.
		// spring에서는 16의 값을 권장한다
		// >> 내부에서 해쉬함수를 이용해서 암호화를 하는데 
		// 		16번 반복하고 그 중 임의의 값을 선택하라 
	...
	@RequestMapping(value="test",produces= {"text/plan;charset=utf8"}, consumes="application/json")
